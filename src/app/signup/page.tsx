  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 max-w-sm w-full text-center">
        <a href="/" className="inline-block text-xl font-bold text-gray-900 tracking-tight mb-8">
          WebCraft<span className="text-blue-600">Studio</span>
        </a>

        <h1 className="text-2xl font-bold text-gray-900 mb-2">Create your account</h1>
        <p className="text-gray-500 text-sm mb-8 leading-relaxed">
          Sign up with Google to access your client dashboard once your site is
          live.
        </p>
